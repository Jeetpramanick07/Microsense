...
export default function App() {
  ...
  return (
    <AppShell
      title={titles[location.pathname] || 'MicroSense AI-Cam'}
    ...
    >
      <Routes>
        <Route
          path="/"
          element={<Dashboard backendOnline={backendOnline} />}
        />

        <Route
          path="/analyze"
          element={<Analyze setLatestResult={setLatestResult} />}
        />

        <Route
          path="/results"
          element={<Results latestResult={latestResult} />}
        />
